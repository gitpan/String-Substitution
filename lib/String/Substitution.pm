...
BEGIN {
  $String::Substitution::VERSION = '1.000008';
}
BEGIN {
  $String::Substitution::AUTHORITY = 'cpan:RWSTAUNER';
}
...
=for :stopwords Randy Stauner gsub runtime precompiled CPAN AnnoCPAN RT CPANTS Kwalitee
diff IRC
...
L<http://search.cpan.org/dist/String-Substitution>

=item *

RT: CPAN's Bug Tracker

L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=String-Substitution>

=item *

AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/String-Substitution>

=item *

CPAN Ratings

L<http://cpanratings.perl.org/d/String-Substitution>

=item *

CPAN Forum

L<http://cpanforum.com/dist/String-Substitution>

=item *

CPANTS Kwalitee

L<http://cpants.perl.org/dist/overview/String-Substitution>

=item *

CPAN Testers Results

L<http://cpantesters.org/distro/S/String-Substitution.html>

=item *

CPAN Testers Matrix

L<http://matrix.cpantesters.org/?dist=String-Substitution>
...
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=String-Substitution>.  I will be
notified, and then you'll automatically be notified of progress on your bug as I make changes.

=head2 Source Code


L<http://github.com/magnificent-tears/String-Substitution/tree>

  git clone git://github.com/magnificent-tears/String-Substitution.git
