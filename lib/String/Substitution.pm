...
BEGIN {
  $String::Substitution::VERSION = '1.001';
}
BEGIN {
...
=for :stopwords Randy Stauner gsub runtime precompiled cpan testmatrix url annocpan anno
...
L<http://www.cpantesters.org/distro/S/String-Substitution>
...
L<http://deps.cpantesters.org/?module=String::Substitution>
...
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=String-Substitution>. You will be automatically notified of any
progress on the request by the system.

=head2 Source Code


L<http://github.com/rwstauner/String-Substitution>
